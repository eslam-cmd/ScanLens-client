  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-slate-800/80 bg-slate-950/80 backdrop-blur-md">
      <div className="container mx-auto flex h-16 items-center justify-between px-3 sm:px-6 lg:px-8">
        ...
        >
          <div className="relative flex h-10 w-10 items-center justify-center overflow-hidden rounded-xl border border-sky-500/30 bg-slate-900/80 shadow-lg shadow-sky-500/10 ring-1 ring-white/5">
            <div className="absolute inset-0 bg-gradient-to-br from-sky-500/20 via-transparent to-blue-500/10 opacity-90 transition-opacity duration-500 group-hover:opacity-100" />
            <Image
          ...
          <div className="flex flex-col leading-none">
            <span className="text-base sm:text-xl font-extrabold tracking-tight text-white">
              Islam <span className="text-sky-400">Hadaya</span>
            </span>
            <span className="text-[9px] sm:text-[10px] font-medium uppercase tracking-[0.18em] text-slate-400">
              Brand-ready interface
            </span>
          </div>
        </Link>
