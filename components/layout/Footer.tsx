        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 sm:gap-8 pb-8 sm:pb-12 border-b border-slate-800/50">
          ...
          <div className="col-span-2 sm:col-span-1">
            <div className="flex items-center gap-2 mb-3">
              <div className="relative flex h-9 w-9 items-center justify-center overflow-hidden rounded-xl border border-sky-500/30 bg-slate-900/80 shadow-lg shadow-sky-500/10">
                <div className="absolute inset-0 bg-gradient-to-br from-sky-500/20 via-transparent to-blue-500/10" />
                <Image
                  src="/img/logo-placeholder.svg"
                  alt="Islam Hadaya logo placeholder"
                  width={24}
                  height={24}
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[10px] font-mono text-sky-400 bg-sky-500/10 px-1.5 py-0.5 rounded-full border border-sky-500/20 w-fit">
                  Brand Ready
                </span>
              </div>
            </div>
            ...
            <p className="text-xs sm:text-sm text-slate-400 leading-relaxed max-w-xs mb-4">
              AI-powered security scanning experience with a custom brand
              identity ready for your logo and visual direction.
            </p>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 pt-6 sm:pt-8">
          <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-4 text-xs sm:text-sm">
            <span className="flex items-center gap-1.5">
              ...
              Made with <Heart className="h-3.5 w-3.5 text-rose-400" /> by Islam
              Hadaya
            </span>
            <span className="hidden sm:inline text-slate-600">•</span>
            <span className="text-slate-500">
              © {currentYear} Islam Hadaya. All rights reserved.
            </span>
          </div>
